...
class NativeQueryBuilder extends Doctrine\DBAL\Query\QueryBuilder
{
    ...
    {
        return parent::where(...Helpers::separateParameters($this, func_get_args()));
    }
    ...
    {
        return parent::andWhere(...Helpers::separateParameters($this, func_get_args()));
//        return call_user_func_array('parent::andWhere', Helpers::separateParameters($this, func_get_args()));
    ...
    {
        return parent::orWhere(...Helpers::separateParameters($this, func_get_args()));
